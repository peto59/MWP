...
#elif LINUX
            _hostname = new StringSetting(ShareName, "Hostname", System.Net.Dns.GetHostName());
#endif
...
#elif LINUX
        private static Setting<string> _hostname = new StringSetting(ShareName, "Hostname", System.Net.Dns.GetHostName());
#endif

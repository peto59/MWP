...
namespace MWP_Backend.DatatypesAndExtensions
{
    ...
    public sealed class Artist : MusicBaseContainer
    {
        ...
        /// <summary>
        /// First or default <see cref="MWP_Backend.DatatypesAndExtensions.Song"/>
        /// </summary>
        public Song Song => Songs.Count > 0 ? Songs[0] : new Song("No Name", new DateTime(1970, 1, 1), "Default", false);

        /// <summary>
        /// List of <see cref="MWP_Backend.DatatypesAndExtensions.Album"/>s composed by this <see cref="Artist"/>
        /// </summary>
        ...
        /// <summary>
        /// Adds <see cref="MWP_Backend.DatatypesAndExtensions.Song"/>s from <paramref name="songs"/>
        /// </summary>
        /// <param name="songs">List of <see cref="MWP_Backend.DatatypesAndExtensions.Song"/>s to be added</param>
        ...
        /// <summary>
        /// Adds <see cref="MWP_Backend.DatatypesAndExtensions.Song"/> from <paramref name="song"/>
        /// </summary>
        /// <param name="song"><see cref="MWP_Backend.DatatypesAndExtensions.Song"/> to be added</param>
        ...
        /// <summary>
        /// Removes <see cref="MWP_Backend.DatatypesAndExtensions.Song"/> matching <paramref name="song"/>
        /// </summary>
        /// <param name="song"><see cref="MWP_Backend.DatatypesAndExtensions.Song"/> to be removed</param>
        public void RemoveSong(Song song)
        {
            Songs.Remove(song);
        }
        /// <summary>
        /// Removes <see cref="MWP_Backend.DatatypesAndExtensions.Song"/>s matching <paramref name="songs"/>
        /// </summary>
        /// <param name="songs">List of <see cref="MWP_Backend.DatatypesAndExtensions.Song"/>s to be removed</param>
        ...
        /// <summary>
        /// Gets full path to <see cref="Artist"/>'s image
        /// </summary>
        /// <param name="name">name of <see cref="Artist"/></param>
        ...
        /// <summary>
        /// Adds new alias to this <see cref="Artist"/>
        /// </summary>
        /// <param name="newAlias">new alias for this <see cref="Artist"/></param>
        ...
        /// <summary>
        /// Gets <see cref="Artist"/> from <paramref name="id"/>
        /// </summary>
        /// <param name="id">Id of <see cref="Artist"/> to return</param>
        /// <returns><see cref="Artist"/> matching <paramref name="id"/></returns>
        ...
        /// <summary>
        /// Whether two <see cref="Artist"/>s are equal
        /// </summary>
        /// <param name="other">other <see cref="Artist"/></param>
